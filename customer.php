...
<div id="main">
  <h2><span style="font-size:30px;cursor:pointer" onclick="openNav()">☰ </span> <b>CUSTOMER</b> &nbsp;   &nbsp;  <i>place shipping order</i><a href="logout.php"><button name="logoutindex" type="Submit" class="btn"  style="color:#ffffff;background-color:#112235;  float: right; margin-right: 20px; ">Logout</button></a></h2>
  <?php
...
<center><form name="cargo_details" method="POST" action="customerdetails.php" class="form-horizontal" enctype="multipart/form-data" style="margin-top: 40px;">
