...
if (isset($_POST['destination'])&&
	...
	$sql2="INSERT INTO shipping_order(email,destination,shipping_date,goods_perishability,goods_type,
	goods_weight,current_location)VALUES ('$user_check','$destination','$show_date','$goods_perishability',
	'$goods_type','$goods_weight', '$current_location')";
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="number_containers" name="number_containers" type="text" value="<?php echo ceil($numberOfContainers); ?>" class="form-control input-md" readonly>
