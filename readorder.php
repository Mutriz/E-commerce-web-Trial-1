...
<div id="main">
  <h2><span style="font-size:30px;cursor:pointer" onclick="openNav()">☰ </span> <b>ADMINISTRATOR</b> &nbsp;   &nbsp;  <i>View order</i><a href="logout.php"><button name="logoutindex" type="Submit" class="btn"  style="color:#ffffff;background-color:#112235;  float: right; margin-right: 20px;">Logout</button></a></h2>
  <?php
  $retrieveorder="SELECT * FROM shipping_order WHERE pay_status='1' AND book_status='1'";
$result=mysqli_query($conn,$retrieveorder);
